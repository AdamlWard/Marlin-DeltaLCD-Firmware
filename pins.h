...
#define X_MIN_PIN          -1
#define X_MAX_PIN          47  // AW: MAPPED TO CORE PIN, PORT PE3

#define Y_STEP_PIN         30
#define Y_DIR_PIN          31
#define Y_ENABLE_PIN       19
#define Y_MIN_PIN          -1
#define Y_MAX_PIN          40  // AW: Moved for conflict with SSDS.  EXP1 Pin 2 

#define Z_STEP_PIN         32
#define Z_DIR_PIN          33
#define Z_ENABLE_PIN       17
#define Z_MIN_PIN          37  // Use E-STOP header for autolevel Z probe
#define Z_MAX_PIN          36
...
#define HEATER_2_PIN       -1
#define HEATER_BED_PIN     14  // Bed
#define FAN_PIN            16  //core 42 -- marked TCK on printrboard // Fan 16
...
#define SDPOWER            -1
#define SDSS               41 //AW: Moved to 41 (phys pin) for external SD support ///// 26 // AW: Moved for conflict with Y-stop pin. 
#define LED_PIN            -1
#define PS_ON_PIN          -1
#define KILL_PIN           -1
#define ALARM_PIN          -1
...
// these pins are defined in the SD library if building with SD support
  ...
  //arduino pin which triggers an piezzo beeper
    ...
    //buttons are directly attached using AUX-2
    #define BTN_EN1 10 // PC0
    #define BTN_EN2 11 // PC1
    #define BTN_ENC 12 // PC2 - the click
